...
const dict = {
  uk: {
    ...
    "about.body":
      "Куршацов Андрій — AI Creator та digital-спеціаліст з 17 річним досвідом у розробці та SEO просуванні сайтів, AI-контенті, генерації музики, відео та вайб кодингу. Допомагаю брендам і авторам говорити мовою майбутнього.",
